...
export default function SupportPageContent() {
  ...
  return (
    <main className="min-h-screen flex flex-col" style={{ background: 'var(--background)' }}>
      <header className="sticky top-0 z-10 border-b" style={{ background: 'var(--background)', borderColor: 'var(--card-border)' }}>
        <div className="max-w-7xl mx-auto px-4 py-3 sm:px-6 sm:py-4 flex justify-between items-center gap-3 sm:gap-4">
      ...
      <div className="max-w-3xl mx-auto w-full px-4 py-8 sm:py-12 text-center">
        <h1 className="text-2xl sm:text-3xl font-bold" style={{ color: 'var(--foreground)' }}>
          {t('support.title')}
        </h1>

        <p className="mt-4 text-base sm:text-lg leading-relaxed max-w-xl mx-auto" style={{ color: 'var(--gray-text)' }}>
          {t('support.appDescription')}
        </p>
      </div>

      <div className="max-w-4xl mx-auto w-full px-4 mt-8 sm:mt-12">
        <h2 id="support-screenshots-heading" className="text-center text-lg font-semibold mb-4" style={{ color: 'var(--foreground)' }}>
          {t('support.screenshotsTitle')}
        </h2>
        <ScreenshotCarousel />
      </div>

      <section className="max-w-4xl mx-auto w-full px-4 mt-12 sm:mt-16 pb-12" aria-label={t('footer.contactAndLegal')}>
