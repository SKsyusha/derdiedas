...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "der die das trainer",
    "learn German articles online",
    "German article simulator",
    "der die das practice",
    "German definite articles exercise",
    "interactive German grammar trainer",
    "German noun gender trainer",
    "der die das quiz",
    "German article typing trainer",
    "Goethe A1 German articles practice",
    "Goethe A2 grammar preparation",
    "German A1 grammar quiz online",
    "German A2 grammar trainer online",
  ],
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta name="apple-itunes-app" content="app-id=6759857767" />
